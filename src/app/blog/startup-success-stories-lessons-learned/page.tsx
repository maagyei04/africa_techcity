                        ...
                        {openSections.includes(0) && (
                            <div className="mt-4">
                                <p className="text-gray-400">
                                    ...
                                    These stories serve as powerful sources of inspiration, reminding us that even the most daunting obstacles can be overcome with determination, resilience, and a unwavering commitment to ones vision. They showcase the power of perseverance, adaptability, and innovation – qualities that are essential for any entrepreneur seeking to make their mark in a competitive and ever-changing business landscape.
                                    ...
                                    Ultimately, studying successful startup stories is not just about gaining knowledge; its about cultivating the mindset and resilience required to weather the storms and seize opportunities. By immersing ourselves in these narratives, we can draw inspiration, learn from the mistakes and triumphs of others, and forge our own paths to entrepreneurial success.
                                </p>
                            </div>
                        )}
                    </div>
                        ...
                        {openSections.includes(3) && (
                            <div className="mt-4">
                                <p className="text-gray-400">
                                    ...
                                    A strong team is not just about assembling a group of talented individuals; its about fostering a collaborative and supportive environment where everyones contributions are valued and encouraged. Successful startups recognize that each team member brings unique skills, experiences, and perspectives to the table, and they actively seek to leverage these strengths to drive innovation and problem-solving.

                                    Moreover, successful startups cultivate a culture of passion and dedication within their teams. They inspire their team members to embrace the companys vision and mission, fostering a sense of ownership and commitment. This passion and dedication fuel the teams motivation and resilience, enabling them to navigate through the inevitable challenges and setbacks that come with building a successful startup.

                                    By building a strong and dedicated team, successful startups create a synergistic environment where ideas can flourish, challenges can be tackled collaboratively, and collective efforts can propel the company towards its goals. The collective expertise and passion of the team members become a driving force for innovation, adaptability, and sustained growth, ultimately contributing to the startups long-term success.
                                </p>
                            </div>
                        )}
                    </div>
