  ...
  return (
    <div className="bg-darkBlue text-white px-5 md:px-20">
      <main className="text-center py-20">
        <h2 className="text-4xl font-bold mb-4 max-w-3xl mx-auto">Collaborate, <span className="text-orange-500">Create</span>, and Build with Africa Techcity</h2>
        <p className="max-w-4xl mx-auto mb-8 text-gray-400">Join a community where creativity meets purpose. At Africa Techcity, we provide the resources, guidance, and collaborative spaces that empower you to thrive and turn ideas into impact.</p>
      ...
      <section className="py-10 bg-darkBlueLight">
        <div className="flex flex-col md:flex-row md:justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <p className="max-w-4xl mx-auto mb-8">
              Discover how Africa Techcity brings together the best resources and expertise to drive digital success. We are at the forefront of innovation, offering cutting-edge solutions tailored to your needs. From co-working spaces to Offshore Outsourcing, our team is dedicated to turning your ideas into reality.
            </p>
            <p className="max-w-4xl mx-auto mb-8">
            ...
            <p className="max-w-4xl mx-auto mb-8">
              At Africa Techcity, we don&apos;t just build technology; we create opportunities for growth, foster creativity, and drive progress in every project we undertake. Join us as we pave the way for the future of technology and digital transformation!
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-center space-x-0 md:space-x-8">
          <div className="text-darkBlue p-6 rounded-xl shadow-md border border-white mb-8 md:mb-0 bg-[#0E304FFF]">
            ...
            <p className='text-gray-400'>At Africa Techcity, we believe in turning ideas into impactful digital solutions. Our team is dedicated to helping you achieve your goals with industry-leading technology and strategies. </p>
          </div>
          <div className="text-darkBlue p-6 rounded-xl shadow-md border border-white mb-8 md:mb-0 bg-[#0E304FFF]">
          ...
          <div className="text-darkBlue p-6 rounded-xl shadow-md border border-white mb-8 md:mb-0 bg-[#0E304FFF]">
            ...
            <p className='text-gray-400'>At Africa Techcity, we provide comprehensive software training programs designed to equip you with the skills and knowledge needed to excel in the digital landscape.</p>
          </div>
          <div className="text-darkBlue p-6 rounded-xl shadow-md border border-white mb-8 md:mb-0 bg-[#0E304FFF]">
            <Image src="/images/flash.png" alt="flash logo" width={20} height={20} />
            ...
            <p className='text-gray-400'>Africa Techcity offers expert guidance and resources to help you navigate the process of studying in the USA or Canada, opening doors to new opportunities and experiences.</p>
          </div>
        </div>
      </section>
          ...
          <div className="md:w-1/2 flex flex-col md:space-y-4">
            <div className="flex items-start space-x-4 mb-4">
              ...
              <p className="text-gray-300">
                Africa Techcity is a leading choice for businesses in West Africa and North America, providing exceptional value through innovative technology solutions and deep industry expertise.
              </p>
            </div>
            <div className="flex items-start space-x-4 mb-4">
              <Image src="/images/verify.png" alt="icon" width={24} height={24} />
            ...
            <div className="flex items-start space-x-4 mb-4">
              <Image src="/images/verify.png" alt="icon" width={24} height={24} />
              <p className="text-gray-300">
                Choosing Africa Techcity means choosing a partner dedicated to your growth, operational efficiency, and strategic success in an increasingly digital world.
              </p>
            </div>
          </div>
        </div>
